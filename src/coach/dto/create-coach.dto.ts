...
import { IsInt, IsNumber, IsString, IsOptional, IsBoolean, IsEnum, IsArray, Min, MaxLength, IsNotEmpty } from 'class-validator';
...
export class CreateCoachDto {
  ...
  @ApiProperty({ description: '个人简介', example: '专业滑雪教练，有5年教学经验' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(1000)
  bio: string;
  ...
  @ApiProperty({ 
    ...
    example: '[{"name": "国际滑雪教练认证", "issuer": "国际滑雪联合会", "year": 2020}]',
    required: false 
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({ 
    ...
    example: '{"weekdays": ["Monday", "Wednesday", "Friday"], "hours": {"start": "09:00", "end": "17:00"}}',
    required: false
  })
  @IsString()
  @IsOptional()
